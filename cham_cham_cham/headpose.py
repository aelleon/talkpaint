...
while cap.isOpened():
    ...
    cv2.putText(image, f"Lives: {lives}", (20, 50), cv2.FONT_HERSHEY_SIMPLEX, 2, (0,255,0), 4)
    ...
    if results.multi_face_landmarks:
        ...
        for face_landmarks in results.multi_face_landmarks:
            ...
            _, rotation_vec, translation_vec = cv2.solvePnP(face_3d, face_2d, cam_matrix, distortion_matrix)
    ...
    if win_message_time is not None:
        cv2.putText(image, "You won! 5 in a row!", (20, 300), cv2.FONT_HERSHEY_SIMPLEX, 2, (0,255,0), 4)
    ...
    if game_state == "waiting":
        ...
        cv2.putText(image, result_text, (20, 300), cv2.FONT_HERSHEY_SIMPLEX, 2, color, 4)
        cv2.putText(image, f"Forbidden Direction: {forbidden_direction}", (20, 150), cv2.FONT_HERSHEY_SIMPLEX, 2, color, 4)
        cv2.putText(image, f"Detected Direction: {result_direction}", (20, 210), cv2.FONT_HERSHEY_SIMPLEX, 2, color, 4)
